...
export default function FreeBoardPage() {
  ...
  const fetchPosts = async (page: number) => {
    setLoading(true)
    try {
      const response = await fetch(`/api/posts?page=${page}&limit=10&category=free`)
            ...
            <div id="sh_content" className="flex-1">
              <div id="sh_bo_list">
                <div className="list_top flex justify-between items-center mb-4">
                  <a href="/board/free/rss" className="text-sm text-slate-600 hover:text-blue-600 transition-colors flex items-center gap-2">
                    <FaRss />
                    RSS
                  </a>
                  ...
                  <>
                    ...
                    <div id="sh_list_tbl" className="sh_tbl_common">
                      <table cellPadding="0" cellSpacing="0" className="w-full">
                        <caption className="sr-only">자유게시판 목록</caption>
                        <thead>
                          <tr>
